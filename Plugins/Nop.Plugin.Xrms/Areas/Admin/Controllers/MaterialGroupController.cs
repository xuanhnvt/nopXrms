...
namespace Nop.Plugin.Xrms.Controllers
{
    public partial class MaterialGroupController : BaseAdminController
    {
        ...
        public virtual IActionResult List()
        {
            ...
            return View("~/Plugins/Xrms/Areas/Admin/Views/MaterialGroup/List.cshtml", model);
        }

        [HttpPost]
        public virtual IActionResult List(DataSourceRequest command, SearchMaterialGroupsModel model)
        {
            if (!_permissionService.Authorize(XrmsPermissionProvider.ManageMaterialGroups))
        ...
        public virtual IActionResult Create()
        {
            ...
            return View("~/Plugins/Xrms/Areas/Admin/Views/MaterialGroup/Create.cshtml", model);
        }
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            //activity log
            _customerActivityService.InsertActivity("DeleteMaterialGroup", _localizationService.GetResource("Xrms.ActivityLog.DeleteMaterialGroup"), materialGroup);
        ...
        public virtual IActionResult AddMaterialsPopup(int materialGroupId)
        {
            ...
            //return View(model);
            return View("~/Plugins/Xrms/Areas/Admin/Views/MaterialGroup/AddMaterialsPopup.cshtml", model);
        }

        [HttpPost]
        public virtual IActionResult AddMaterialsPopupList(DataSourceRequest command, MaterialGroupDetailsPageViewModel.SearchMaterialsModel model)
        {
