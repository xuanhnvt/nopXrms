...
using Nop.Plugin.Xrms.Areas.Admin.Models.WaiterOrders;

namespace Nop.Plugin.Xrms.Controllers
{
    public partial class WaiterOrderController : BaseAdminController
    {
        #region Fields
        ...
        public virtual IActionResult List()
        {
            ...
            return View("~/Plugins/Xrms/Areas/Admin/Views/WaiterOrder/List.cshtml");
        }
        ...
        public virtual IActionResult SearchProducts(DataSourceRequest command, ProductListViewModel.SearchProductsModel searchModel)
        {
            ...
            var gridModel = new DataSourceResult
            {
                ...
                {
                    // fill in model values from the entity
                    var productModel = new ProductListViewModel.ProductListRowViewModel()
                    {
                        Id = product.Id,
                        Name = product.Name,
                        Price = product.Price,
